...
public static class HudRenderer
{
    ...
    {
        // HUD text sizing was removed when the sim went audio-only; this renderer is no longer
        // invoked (SpaceSimGame.Draw only clears the screen), so fixed values keep it compiling.
